# Microsoft Developer Studio Project File - Name="InfoGB" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** 編集しないでください **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=InfoGB - Win32 Debug
!MESSAGE これは有効なﾒｲｸﾌｧｲﾙではありません。 このﾌﾟﾛｼﾞｪｸﾄをﾋﾞﾙﾄﾞするためには NMAKE を使用してください。
!MESSAGE [ﾒｲｸﾌｧｲﾙのｴｸｽﾎﾟｰﾄ] ｺﾏﾝﾄﾞを使用して実行してください
!MESSAGE 
!MESSAGE NMAKE /f "InfoGB.mak".
!MESSAGE 
!MESSAGE NMAKE の実行時に構成を指定できます
!MESSAGE ｺﾏﾝﾄﾞ ﾗｲﾝ上でﾏｸﾛの設定を定義します。例:
!MESSAGE 
!MESSAGE NMAKE /f "InfoGB.mak" CFG="InfoGB - Win32 Debug"
!MESSAGE 
!MESSAGE 選択可能なﾋﾞﾙﾄﾞ ﾓｰﾄﾞ:
!MESSAGE 
!MESSAGE "InfoGB - Win32 Release" ("Win32 (x86) Application" 用)
!MESSAGE "InfoGB - Win32 Debug" ("Win32 (x86) Application" 用)
!MESSAGE 
...
# Name "InfoGB - Win32 Release"
# Name "InfoGB - Win32 Debug"
...
SOURCE=.\InfoGB_Resource_win32.rc
# End Source File
# End Group
# End Target
# End Project
